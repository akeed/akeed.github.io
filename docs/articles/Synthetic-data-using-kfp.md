...
*Published: February 16, 2025, together with Tarek Abouzeid*

*Originally published in The Kubeflow Blog at https://blog.kubeflow.org/kfp/2025/02/16/synthetic-data-using-kfp.html*


- [Synthetic Data Generation - Why and How?](#synthetic-data-generation---why-and-how)
- [Key Benefits of Using Synthetic Data](#key-benefits-of-using-synthetic-data)
- [Frameworks for Creating Synthetic Data](#frameworks-for-creating-synthetic-data)
- [The Synthetic Data Vault (SDV)](#the-synthetic-data-vault-sdv)
- [Evaluation Criteria for Synthetic Data](#evaluation-criteria-for-synthetic-data)
- [Our On-Premise Analytics Platform: ARCUS](#our-on-premise-analytics-platform-arcus)
- [Needed environment to create synthetic data](#needed-environment-to-create-synthetic-data)
- [Parallelism needed](#parallelism-needed)
- [Exploring the Creation and Usefulness of Synthetic Data](#exploring-the-creation-and-usefulness-of-synthetic-data)
- [Using Synthetic Data Generators to Enable Multiple Environments without Data Transfer](#using-synthetic-data-generators-to-enable-multiple-environments-without-data-transfer)
- [Summary](#summary)
...
1. Create synthetic data for our on-premise environment use-cases, and - as a side product we save away the synthetic data generator (the pickled model used to create synthetic data).
