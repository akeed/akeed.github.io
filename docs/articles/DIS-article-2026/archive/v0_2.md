...
So the real question is not how to build for today’s technology.
It’s how to build for constant change.
...
Years ago, during the “big data” wave, we made a deliberate choice: separate compute from storage. At the time, it was a technical decision. In hindsight, it was a strategic one.
...
### From analytics to GenAI: evolution, not disruption
...
Developers began to act more like architects.
Business and IT alignment became less about translation and more about shared context.
...
These concepts point towards a more modular and composable way of building AI systems, where capabilities can be combined and orchestrated dynamically. But they are still evolving.
...
We explore these patterns early—but in a structured and controlled way—shaping them to meet enterprise requirements. This includes building the necessary layers around them—gateways, guardrails, and integration patterns.
...
Across network operations, B2C, B2B, and internal IT, we are applying AI to improve how we operate. Or, as one of our colleagues put it: *eat your own dog food—or, better, drink your own champagne.*
...
But sovereignty does not exist in isolation.
It is enabled.

And increasingly, it is enabled by **open source**.
...
We are not abandoning the past.
We are building a path forward from it.

---

### Final thought

If there is one lesson across all these waves—from big data to GenAI—it is this:

**The goal is not to predict the future.
The goal is to be ready for it.**

That means building architectures that can evolve,
organizations that can learn,
and people willing to adapt.
