...
So the real question is not how to build for today’s technology, it’s how to build for constant change.
...
We never really knew what was coming next. But the choices we made—modularity, openness, the ability to evolve—kept us moving.

**Our strategy wasn't to predict the future. It was to be ready for it.**
